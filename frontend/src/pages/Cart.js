...
function decreaseQty(items){
  ...
  fetch(`${process.env.REACT_APP_API_URL}/orders`, {
    ...
    return (
                ...
                <div className="row d-flex justify-content-between">
                        ...
                        <div className="cart-item">
                            <div className="row">
                                ...
                                <div className="col-4 col-lg-1 mt-4 mt-lg-0">
                                    <i id="delete_cart_item" onClick={() => removeCartItem(items)} className="fa fa-trash btn btn-danger"></i>
                                </div>
                    ...
                    <div className="col-12 col-lg-3 my-4">
                        <div id="order_summary">
                            <h4>Order Summary</h4>
                            <hr />
                            <p>Subtotal:  <span className="order-summary-values">{cartItems.reduce((acc,items) => (acc+items.qty), 0)} Units</span></p>
                            <p>Est. total: <span className="order-summary-values">{cartItems.reduce((acc,items)=> (acc + items.product.price * items.qty), 0)}</span></p>
            ...
            </Fragment> : (!completeOrder ? <h2 className="mt-5">Your Cart is Empty.!</h2> :
